	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i=0; i<=trials; i++){
				Document b = new BasicDocument(s);
				b.getFleschScore();
			}
			double estimatedTime2 = (double) ((System.nanoTime() - startTime2)/1000000000.0);
			System.out.print(estimatedTime2+"\t");
			//-------------------------------------------
			double startTime1 = System.nanoTime();  
			for(int i=0; i<=trials; i++){
				Document e = new EfficientDocument(s);
				e.getFleschScore();
			}
			double estimatedTime1 = (double) ((System.nanoTime() - startTime1)/1000000000.0);
			System.out.print(estimatedTime1+"\n");
			//--------------------------------------------
